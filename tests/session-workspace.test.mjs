...
test('source contract: reduced workspace has no Oversight or live-session subsystem', () => {
  assert.doesNotMatch(pluginSource, /OVERSIGHT_|session\.active_list|applyOversightContext/)
})
